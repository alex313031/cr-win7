...
vars = {
  ...
  'src_internal_revision': '13a6bad1a34cfdeff84a3ee4d934d7ad94c24744',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '234e3d4b37e9d398016018ae64c6059ae7eb9559',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c36b4f9856f75196caaade30d73e1c9dc5d01db7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '1eb6afe32f70b37247e0a676103236e9428dcf8d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'c9815acd5a88ae4853cd25f7cb8f2face7cace28',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '95961c38be4ee7a4618edb6bc9e2b40046a96000',
